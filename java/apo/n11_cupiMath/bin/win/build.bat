...
REM ---------------------------------------------------------
cd source
javac -source 1.5 -d ../classes/ uniandes/cupi2/expresionesAritmeticas/mundo/*.java
javac -source 1.5 -d ../classes/ uniandes/cupi2/expresionesAritmeticas/interfaz/*.java
