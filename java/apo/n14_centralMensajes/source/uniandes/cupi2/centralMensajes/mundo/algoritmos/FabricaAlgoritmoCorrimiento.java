...
/**
 * 
 * Construye un {@link AlgoritmoCorrimiento}
 *
 */
public class FabricaAlgoritmoCorrimiento implements IFabricaAlgoritmo {
	...
	public IAlgoritmoEncriptacion crearAlgoritmo() {
		AlgoritmoCorrimiento al = new AlgoritmoCorrimiento();
		al.inicializarCorrimiento();
		return al;
	}
