...
cd source
javac -source 1.5 -classpath ../../lib/cupiFinca.jar:../lib/junit.jar -nowarn -d ../classes/ uniandes/cupi2/cupiFinca/test/*.java
...
cd ../classes
jar cf ../lib/cupiFincaTest.jar uniandes/* -C ../data .
