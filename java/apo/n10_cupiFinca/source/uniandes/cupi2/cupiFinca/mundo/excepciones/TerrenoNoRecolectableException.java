...
/**
 * Esta excepción se lanza si hay un terreno con un producto que no ha terminado su etapa de producción
 */
public class TerrenoNoRecolectableException extends Exception
{
    ...
    {
        super( "El terreno en la posición: " + x + ", " + y + " no tiene productos que se puedan recoger actualmente.");
    }
}
