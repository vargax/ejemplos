...
/**
 * Clase que representa un cultivo de cebolla
 */
public class Cebolla extends Cultivable
{
    ...
    // -----------------------------------------------------------------
    /**
     * El nombre del producto de la cebolla
     */
    public static final String NOMBRE_CULTIVO = "Cebolla";

    /**
     * El costo de instalación de la cebolla
     */
    public static final int COSTO_CULTIVO = 100;

    /**
     * La ganancia por instalación de la cebolla
     */
    public static final int GANANCIA_CULTIVO = 200;

    /**
     * La ruta del archivo con la imagen de la cebolla
     */
    public static final String RUTA_IMAGEN = "./data/imagenes/cebolla.png";
    ...
    /**
     * Construye una nueva cebolla al cultivo.<br>
     ...
     * @param pTiempo El tiempo que lleva de iniciada la producción de la cebolla. pTiempo >= 0
     * @throws PersistenciaException En caso de no leer la imagen del cultivo
     */
    public Cebolla( int pX, int pY, int pAncho, int pTiempo ) throws PersistenciaException
    {
